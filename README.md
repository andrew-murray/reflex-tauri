...
![View of reflex main layout - as of August 2025](./docs/screenshots/reflex-screenshot.png)
...
![Dialog to filter photos by focal length](./docs/screenshots/reflex-screenshot-filter.png)

### A variety of different graphics to choose from
![Pi chart plotted - in front of other graphs](./docs/screenshots/reflex-screenshot-pi-chart.png)

### Compare your final ratings for each photo
![Split bar chart showing ratings in different colours](./docs/screenshots/reflex-screenshot-ratings.png)
